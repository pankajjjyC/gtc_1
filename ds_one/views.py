...
def chartdetection(request):
    ...
    for j in range(1,7):#len(em_list_fig_twolines)   
        ...
        layout=go.Layout(title='', height=400, width=1200,showlegend=False)
...
def chart2(request):
    ...
    context_main={'dfr': tabular_form_context,
    'list_radio':list_radio,'selected_value_dropdown4':selected_value_dropdown4,
    } 
...
def chart1(request):#ds_one home url function view    
    ...
    heat_fig2 = px.imshow(scores2,x=column_header,width=600, height=600)
    ...
    #########################code for bar chart2----------------------
    fig_bar2 = px.bar(            
    data_frame = scores2[dropdown_selected_bat_cur_convrt_string],         
    ...
    context_main={'dfr': tabular_form_context, "chart_heat_map": heat_fig_context,'chart_barchart':fig_bar_context,
    'heat_fig_context2':heat_fig_context2,'fig_bar_context2':fig_bar_context2,
    'column_header':column_header,'data_frame_col_one':data_frame_col_names,
...
def sample2(request):    
    if request.method == 'POST':     
        ...
        'column_header':column_header,'fig_bar_context2':fig_bar_context2,'heat_fig_context2':heat_fig_context2,
