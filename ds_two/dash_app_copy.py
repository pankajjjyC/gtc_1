...
app = DjangoDash('dash_app_copy',external_stylesheets=external_stylesheets) # django app
...
title_waveform_selection = html.H3('Waveform parameters',style={'position':'relative','left':'350px','top':'-5px'})
...
div_time_date_selection = html.Div([
    ...
    html.Div(['Window length (seconds)', dcc.Input(id='duration',
                                                ...
                                                value=300,
                                                min=1, 
                                                max=60*60)],style={'visibility':'hidden'})
    ])
...
div_signal_raw = html.Div(className="no_class",
    ...
    dcc.Graph(id='fig_signal_raw',
            ...
            style={'width':800, 
                'height':250})
    ],style={'position':'relative','left':'150px','top':'-30px'})
...
div_cover=html.Div([
    ...
    html.Div(style={'backgroundColor':'white','position':'relative','top':'-650px','width':'1000px','height':'700px'})
